-- ============================================================================
-- ROLLBACK for migration 021 — brand asset storage
-- Reverts get_center_theme to the no-logo version and drops storage policies.
-- The 'branding' bucket is left in place (drop manually if empty & unwanted).
-- ============================================================================
